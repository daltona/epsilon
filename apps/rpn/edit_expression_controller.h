#ifndef RPN_EDIT_EXPRESSION_CONTROLLER_H
#define RPN_EDIT_EXPRESSION_CONTROLLER_H
...
public:
  EditExpressionController(Responder * parentResponder, HistoryController * historyController, RpnStore * rpnStore);
